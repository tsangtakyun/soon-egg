  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-[#f7f7f5] px-4">
      <section className="w-full max-w-md rounded-lg border border-zinc-200 bg-white p-6 shadow-sm">
        <h1 className="text-2xl font-black text-zinc-950">登入 SOON-EGG</h1>
        <p className="mt-2 text-sm text-zinc-500">使用 Supabase Auth 連接你的創作者帳戶。</p>
        <form className="mt-6 space-y-4">
          ...
          <button type="button" className="w-full rounded-md bg-zinc-950 px-4 py-2 text-white">登入</button>
        </form>
        <p className="mt-4 text-sm text-zinc-500">未有帳戶？ <Link href="/signup" className="font-medium text-zinc-950">註冊</Link></p>
      </section>
    </main>
  );
}
