...
export function PhonePreview({ profile, theme }: { profile: PhonePreviewProfile; theme: PhonePreviewTheme | null }) {
  ...
  return (
    <div className="mx-auto w-full max-w-[320px] rounded-[32px] border-8 border-zinc-950 bg-zinc-950 p-2 shadow-2xl">
      <div className="min-h-[620px] overflow-hidden rounded-[24px] p-5 text-center" style={{ background: themeBackground, color: textColor }}>
        ...
        <img src={profile.avatar_url || "/soon-egg.png"} alt={displayName} className="mx-auto mt-6 h-20 w-20 rounded-full bg-white object-cover" />
